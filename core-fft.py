...
# read in header (Currently useless? [Spence 2017/09/06])
# if o.header == 1:
...
# head.getint('ggse_header','chipblock')
options.avg = o.avg if o.avg > 0 else 1
# if bool(o.nchan) else head.getint('ggse_header','n_chan')
options.n_chan = o.nchan
options.n_ffts = o.X
...
if ret == 0:
    if (o.header > 0) and (o.header != 2):
        ...
        if o.skip_avg > 0:
            newh.set('ggse_header', 'fft_skip_avg', o.skip_avg)
        if o.skip_fft > 0:
            newh.set('ggse_header', 'fft_skip_fft', o.skip_fft)
